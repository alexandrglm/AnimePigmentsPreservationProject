...
**Lifework used **Taiyo Shikisai** cel paints for coloring.** As I wrote before, Toei Doga used STAC cel paints, but back then most other companies used Taiyo Shikisai cel paints. So Lifework's colour director converted STAC→Taiyo Shikisai based on *Saint Seiya* colour direction created at Toei Doga.

**With today's digital coloring, such problems don't exist at all, but back then such effort was required.** STAC paints with good colour development clarity versus Taiyo Shikisai with many subdued colors. You couldn't make them exactly the same. So in Lifework production episodes, **Seiya** and other characters' colors were somewhat different. But thanks to the colour director's good sense in organizing them, you can't tell the difference unless you look very carefully.
...
**The basic principle for this kind of thing is "the same shape and colour as what appears on TV is lined up in toy store displays."** So since product (toy) colors and colour divisions were already decided, the version appearing in the main story had to match the toys.
