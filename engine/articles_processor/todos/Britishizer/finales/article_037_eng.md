...
So the colors of cels painted according to the colour direction are very different from the cel colors in the actual completed screen. For this production, we created a colour conversion filter specifically for colour direction. When creating character colors, we place this filter over the cels to check the colour tones. Honestly, it's incredibly time-consuming, but working while getting excited about how the screen will turn out is very enjoyable.
