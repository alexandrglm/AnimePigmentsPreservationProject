...
Writing this might make TV work seem low-level, but "Kozue Anime's" coloring level was actually quite high (I realised this even more after joining Toei Doga and seeing finished cels from other Toei-affiliated finishing companies).
...
At the time, cel finishing workflows often separated "hand tracing" and "coloring" workers, but "Kozue Anime" deliberately didn't separate workers, with the policy that "the person painting does all the tracing too." So I thought we'd do all the colour tracing for these "flame cuts" too.
