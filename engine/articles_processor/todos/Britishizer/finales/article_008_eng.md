...
**When I started finishing work at that Ikebukuro production company, since the finishing production I belonged to mainly took Toei work, the paints used there were naturally mostly **STAC (Saito Tele-Anima Colors Co.Ltf)** **(スタック)** **paints.** But occasionally, we'd take rush jobs from production companies other than Toei Doga, and most of those jobs used different paints from Toei's; the **Taiyo Shikisai (太陽色彩)** paints.
...
**As I wrote about *Yamato* last time, STAC colors with overall vivid tones versus Taiyo Shikisai paints with matte tones.** STAC colors that could appear transparent when painted thin versus Taiyo colors that were uniform in any colour and dried quickly. STAC colors with high transparency but prone to spoiling with rotten egg-like odors versus Taiyo colors that would quickly harden if you weren't careful. STAC colors that sometimes had fluffy white mold growing on the surface when you opened them versus Taiyo colors that could cause white clouding in finished painting if not well stirred.

**As colour design or colour direction, which I preferred depends entirely on the case.** When wanting vivid colors, STAC colors were good, and for subdued intermediate tones, definitely Taiyo Shikisai. Most of all, Taiyo colors had many colors and were easy to create gradations, but the numbering system was complex, often leading to specification and painting mistakes... (bitter laugh).

**But for us doing finishing painting work on site, more than paint colour development, it was first about ease of painting and drying speed.** Paint spread and brush movement favored STAC colors, while drying speed favored Taiyo Shikisai. Ah, colour trace work ease was definitely STAC colors. Especially STAC's "**Trace Black**" used for line corrections had very fine, smooth material quality and was the best paint for hand tracing.
...
**Even when Taiyo Shikisai paint jobs came in, they weren't constantly high volume, so naturally we couldn't afford to stock a complete set of Taiyo Shikisai paints.** So what did we do? We used "conversion charts" to convert Taiyo colour specifications to STAC colors for painting.
...
**As I wrote earlier, Taiyo colors and STAC colors have basically no compatibility.** Even gray paints have subtly different colors. So we very forcibly and roughly "converted" them for painting (laughs). It's unthinkable now, but back then it was OK even if colors were somewhat different.
