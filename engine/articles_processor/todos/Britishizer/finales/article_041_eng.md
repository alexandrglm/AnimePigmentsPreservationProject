...
I'm in charge of deciding the colors for that text (incidentally, the person choosing which phrases to change colour for emphasis is assistant director Goto-kun), and I'm having fun playing with the colour balance, deliberately making it easy to read for some episodes and hard to read for others (laugh). Not just the main story colors—"colour" is interesting in places like this too.
