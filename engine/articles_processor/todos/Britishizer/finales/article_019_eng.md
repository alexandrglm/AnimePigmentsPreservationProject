...
**So, *Saint Seiya*.** As I wrote before, back then all character colour design was colour-directed by art designers. We'd make test-painted colour samples with colors specified by art, check them with producers, directors, character designers, etc., and repaint if there were modifications. Same with *Saint Seiya* - I first test-painted main characters with colour specifications from Kubota-san. At that character colour decision meeting, I first met **Araki-san** and **Kubota-san**.
