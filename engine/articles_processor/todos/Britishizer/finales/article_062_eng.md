...
The eternal theme for those doing colour direction is, above all, expressing "water." Recently it's often processed with 3D CG, but expressing "water" through animation + coloring is still anime's foundation. So while enjoying the competitions, I'm just looking at water (laugh).
...
For example, like me with *Saint Seiya*, normally one colour director would be assigned to a series, creating main character colors and managing colour direction sheets, but this *Dragon Ball* team didn't assign a dedicated colour director. Staff room members - chief director, directors, and assistant directors - decided all colour direction matters, with production coordinators and assistant directors managing colour direction. They'd give colour direction decided in the staff room directly to finishing production companies for work. That was roughly the system.
