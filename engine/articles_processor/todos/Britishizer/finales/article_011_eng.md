...
**Paints have different usage frequencies depending on colour.** Depending on the works coming in at the time, colors divide into frequently used and not-so-frequently used. For some colors, it wasn't uncommon to not even open the lid for a month or so.
