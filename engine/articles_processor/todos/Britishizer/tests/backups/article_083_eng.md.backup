...
*Casshern Sins* Colour Design Notes - this week covers episodes 13-18 of the main story. Ah, it became 5 installments total for this series. According to the original plan, this time would go all the way to the final episode. But then, depending on the region, the final episode hasn't aired yet... So I did the OP & ED edition last time, making it 5 installments total.
...
The key point for this episode's colour creation was the cave interior scenes. Since *Casshern Sins* screens tend to become dark easily, I had been consciously creating brighter colors for the past several episodes, but in episode 13 I wanted the cave's darkness, especially around the campfire where Braiking Boss speaks, to be dark. That's what creates atmosphere. So I created it darker with the mindset of "it's okay if it gets crushed, if it's not visible!"

When we colour designers work on character colour design, we dim or block the lighting around our monitors to make the environment dark so we can see the monitor's colour output correctly. Especially when creating colors for dark scenes, it needs to be dark. In bright ambient light situations, the monitor - or rather, your eyes - get overwhelmed by the surrounding brightness and you can't see the deep colour portions.
...
From around these episodes, crowds appear frequently, but I left the work mostly to the colour direction staff. The crowd colors created a nice atmosphere. I had the colour direction staff create samples by creating the atmosphere with main episode cuts and rough coloring, then checked those. Almost all were approved in one go. They understood the colour world of *Casshern Sins* perfectly - wonderful.
...
Yukie-san's backgrounds aren't digital backgrounds drawn on computer, but actually painted with paints on watercolor paper. These were scanned and digitized by a scanning company. Yukie-san's unique watercolor bleeding quality worked incredibly well with the photography processing bleeding, and the subtle colour mixing in the sky (clouds) and the blue of the glass tile backgrounds were particularly beautiful - the feeling of colors gently emerging on screen was exquisite.
...
Horto, Hoty, Holter - robots who seem to be Luna's siblings. From that concept, when creating colors I thought to make them "a bit soft, with a thin sense of physicality." So I made their hair colour traced.
