...
So I deliberately didn't use the existing TV series or previous theatrical versions' colour direction (色指定) as reference or foundation. That said, since it was an "original work adaptation," I couldn't completely ignore the original and do whatever I wanted, so I bought the three available colour illustration collections by Oda-san (←out of my own pocket (laugh)) and decided to try my hand at it using those colors as reference.
...
While flipping through that colour illustration collection, I remembered Director Sakai's words: "I think it would be good if it came together with colors that feel 'transparent.'" Ah, I see. So this is what the director wants. Watercolor-touch colors that feel clear, but with solid presence. Could we somehow achieve this unique atmosphere on screen? That's what I thought about.

While thinking about such things, I built up the main characters' base colors. I lined up faces of all nine people (yes, nine people!) on screen, adjusting balance by making this one darker or that one lighter, repeating fine adjustments to aim for that colour illustration collection's atmosphere. First I balanced Luffy and Nami, then placed the other members' colors. As a result of being conscious of the colour illustrations' transparency, first Luffy's skin became brighter than previous anime versions. With that balance, Zoro and Robin also ended up with considerably brighter skin tones. Oh, Brook and Chopper didn't change much as a result (laugh).
...
"Hmm!" said Director Sakai. "Could you make Nami's hair colour a bit darker?" Plus some other small requests about everyone's eye colors. "Well, let's go with this for now," and so the base colors were tentatively decided.
