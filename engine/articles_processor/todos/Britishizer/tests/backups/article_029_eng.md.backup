...
The original visuals were "soft and soft, clean but fluffy," so I really wanted to make outline (main line) colors lighter and brighter, but actually trying it - while decent in still images, in moving pictures they either dissolved too much into backgrounds or floated too much. So I kept it to just slightly softer. Naturally, according to spatial brightness, character colors, main lines, colour tones, and density were all adjusted accordingly.
