...
*Hakaba Kitaro*, currently airing to great acclaim, finished creating all character colors last week, so my work is mostly done. What remains is checking the portions that colour directors are handling for episodes #10 and #11, plus checking the main story rushes.
...
In this *Akuma-kun* series, I handled the coloring settings for the main characters and the main guest demons of each episode, plus the colour direction and inspection for the opening and ending, and the colour direction for the first few episodes after the series started. Oh, and I also participated in the first theatrical version.
...
These Twelve Apostles were summoned by Akuma-kun blowing his ocarina from a magic circle, and at this time, there would be special coloring with footlight-style shadows from the glowing magic circle as a light source, and this was great. With pink to purple high-contrast tones, the backgrounds and cels finished in exactly my favorite colour usage, and I was very happy—shameless self-praise (laugh).
