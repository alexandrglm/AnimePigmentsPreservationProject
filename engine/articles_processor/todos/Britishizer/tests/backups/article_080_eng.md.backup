...
However, from the latter half when the large robot appears, we're using "normal" colour direction. Since it was episode 1, I somehow wanted to end episode 1 with "normal" colour tone. The backgrounds happened to be bright scenes too, so they're raw normal colors.
...
Basically, the first half does scene-by-scene decisions matched to backgrounds, the middle creates scenes with special colour usage matched to what the characters are talking about, and the latter half adds mysterious colour tones to character shadow colors riding on the characters' emotional ups and downs. This flow is actually what I was trying to do throughout the entire series.
