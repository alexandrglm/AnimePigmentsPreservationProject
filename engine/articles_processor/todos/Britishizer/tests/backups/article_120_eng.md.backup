...
For now, I obtained colour direction from TV series team and materials room to create colour samples for this theatrical version. As I wrote last time, since I was plotting to develop colors as theatrical *Dragon Ball Z*, I built up Goku, Vegeta, Piccolo and others based on theatrical colour direction from when I'd handled them before, and also organized and corrected regular characters like Goten and Trunks appearing from this time in my approach as "theatrical basic colour direction" while considering future prospects.

Goten is basically the same as Goku, so mostly the same colour direction. For Trunks, TV colour direction had almost no difference between normal and shadow hair, so I made normal colors somewhat brighter and adjusted shadow colors so hair colour could be felt. Then I strengthened overall shadow colour density (brightness) for better contrast.
...
And Broly. This was senior Sakamoto Yoko-san's work from his previous appearance. She handled colors for works like *Magical Taruruuto-kun*, so pastel colour usage was her characteristic. I remade this toward my approach—or rather my style—for this work, but since this character had already been released once, I couldn't go completely 180 degrees opposite colors. While glaring at the original and seeking more powerful volume, I tried creating a new Broly.
