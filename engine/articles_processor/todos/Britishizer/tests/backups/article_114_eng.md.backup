...
I think any colour designer feels this way, but once you create characters and design scenes, you naturally want to do colour direction on the raw animation yourself and readjust the painted colors against backgrounds.
...
This work has an incredible number of pirates appearing. Kobiki-san handled creating colors for these pirates overall. First, creating colour direction data for pirates appearing across multiple cuts. Based on reference designs Sato-san provided for the pirates, she created colors for the pirate captains seated in the great hall during the "raid" scene, and used that data as colour direction reference for the finishing (仕上げ) staff to paint.
