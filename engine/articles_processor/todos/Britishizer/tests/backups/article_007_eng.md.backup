...
**Episode 5** - The wave cannon's high-contrast colors. "Strong light high-contrast can be just two-colour painting," I think, and this might be the root of such thoughts.
...
**Episode 16** - The story where **Yuki Mori** and **Analyzer** are captured by **Beemera** people while investigating to gather vegetables. This episode uses special coloring throughout, but especially the colour change of Analyzer standing alone against the burning Beemera planet city background is impressive. With overall dark shadow-like colors and only the instruments appearing to glow, that figure is full of melancholy, and Analyzer's sadness comes through in the colors.
...
**In space and other dark backgrounds, cel scratches, dust, and dirt inevitably stand out,** and countless cuts with surface painting for colour error corrections and colour mismatches are visible. Well, that probably also became part of *Yamato*'s "flavor."
...
**The *Space Battleship Yamato* TV series was made with **Taiyo Shikisai** **(太陽色彩)** company paints.** Meanwhile, Toei Doga was using **STAC (Saito Tele-Anima Colors Co.Ltf) **(スタック)**  paints by this time. These two major paint manufacturers' colors actually have no compatibility. Against Taiyo Shikisai's many colors with overall low-saturation matte tones, STAC colors had overall vivid tones with fewer colors. If you painted the TV *Yamato*'s colors with the closest atmospheric STAC colors, that probably became the theatrical version's blue-tinted Yamato. That's what I think.

**In the booklet included with this DVD box set, the original coloring settings from that time were published as reference material.** So for the first time, I learned the original *Yamato* colour direction and paint numbers. The basic ship body was **Z-4**, the ship bottom and smokestack red parts' basic was **Zm-1**. From the paint numbering system, I think these were probably colors created specifically for *Yamato*. Man, I was moved! In plastic model paint terms, that's "Japanese Navy warship colour" and "ship bottom colour" (laughs). After all, *Yamato* is imprinted with these colors in my mind, so I just can't like Toei Doga's "blue-tinted Yamato."
