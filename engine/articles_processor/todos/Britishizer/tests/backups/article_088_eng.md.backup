...
From last week through this week, there was a big move in the colour design room at Toei Animation's (東映アニメーション) Oizumi Studio. Since I became freelance, the room was divided into a room for freelance people and others. And with that came the big move. And personal organization, major cleanup.
...
I had tried searching for suitable paints among Taiyo Shikisai paints that Toei Animation didn't basically use, but even with Taiyo Shikisai's extensive colour range, the colors usable for Coo's body were also subtle. But I was thinking that maybe in the end I'd have to have the director compromise somewhere around there.
...
The new colors made this time would only be usable for *COO* production, and these colors wouldn't remain on Toei Animation's colour chart for use in any work in the future. For such reasons, "increasing new 'colors'" was in a sense a production taboo.
...
The newly made colors were CR-1A and CR-2A. Actually, these 2 colors were Taiyo Shikisai paint colors 56N (←probably) and 45M. I made colour samples using these 2 Taiyo Shikisai paint colors I personally owned and had STAC make them.
...
Also, there were production systems like the theatrical *Dragon Ball Z* I had participated in before entering *COO*, where during crunch time we'd do colour direction with Taiyo Shikisai colors and have Korean studios do the coloring - I thought these could be used in such cases too!

So we could use 4 new colors.

While there were only these 4 colors for heavy use as new colors, I thought that probably during colour direction work, there would be colors I'd want to use like "just here! just this cut!" depending on the cut. In such cases, I could either add paint I made myself to coloring orders cut by cut, or have it ordered from coloring studios that had Taiyo Shikisai paints - I was determined to use every possible means.
