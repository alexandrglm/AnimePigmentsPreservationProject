...
The colour scheme system for Specters was already established in the previous series, so based on that, we referenced the original artwork coloring (for example, whether hair was solid black or white outline in the original) to create colors. So episode 2's guest character Lune became silver-haired.
...
Hades' chamber. The basic character colour balance here is actually my personal favorite. Suppressing brightness while still showing proper colour tones. It feels good (laugh).
