...
In the series of cuts where **Frey** climbs the statue and stabs it with his sword, I made a colour direction error in one cut. A cut needing light reflection from the **Odin** statue was finished in colors without reflection. I missed this during checking and had texture brushing applied with special effects in the wrong colors.
