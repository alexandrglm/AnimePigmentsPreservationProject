...
**"Challenging depictions of scattered internal organs and brain matter that couldn't be drawn on TV" was one of this theatrical version's "selling points."** So animation drew each intestinal fold more finely and boldly, colour direction used reference books to specify colors in detail, and painting this required even more finishing work. Moreover, finishing was much more overseas than domestic production companies. Roughness inevitably stood out. Hence cel delivery inspection and retake processing took incredibly long.
