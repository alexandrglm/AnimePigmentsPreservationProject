...
Both backgrounds and animation finishing gradually progressed, and cuts (in-betweens) for evening and night scenes started coming to colour direction. When a certain number of cuts accumulated in my hands, I'd decide special scene colors while watching the situation with art boards for those scenes.
