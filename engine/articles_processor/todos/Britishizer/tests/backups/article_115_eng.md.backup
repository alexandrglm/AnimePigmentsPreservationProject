...
The rough colour design plan was mostly complete by mid-August, and after that we'd wait for art boards to be completed in sequence to create actual "colors." Between places we'd decided for the trailer, scenes where boards came up relatively early, or scenes where we'd requested boards for CG-related advance work, little by little we had a fair number of scenes with completed decisions.
...
This work has an incredible number of pirates. Kobiki-san generally created colors for these pirates. First was creating colour direction data for pirates appearing across multiple cuts. Based on pirate reference designs from Sato-san, she created colors for the pirate captains seated in the great hall during the "raid" scene, and used that data as colour direction reference for finishing staff painting.
