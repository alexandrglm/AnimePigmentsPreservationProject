...
As usual, production schedules fell behind smoothly (bitter laugh), and the volume requested from Korean productions kept increasing. As I wrote previously, requesting Korean productions = Taiyo Shikisai paints. Learning from spring *Dragon Ball Z* reflections, I gradually prepared, but the more I thought and created conversion colour directions by replacing paints, the wider the gap between Taiyo Shikisai colors and STAC paints became. "If only everything could be made with Taiyo Shikisai colors, how much easier it would be!" Such conflicts constantly swirled in my head.
