...
**In industries dealing with colour - publishing, printing, and others - they almost always use "colour samples," right?** For example, when choosing wallpaper at home centers or even for paint, there are strip-shaped sample bundles at sales floors so you can compare colour differences up close. Similarly, cel paints had strip-shaped colour sample charts.
...
**As a precaution, when painting strips, if you don't properly note what paint number you painted near the painted colour, similar colors are numerous and you'll lose track later (laughs).**
...
**When thinking about and specifying some colour - like the colour of props a character holds - first you envision what kind of colour to use, then use the strip chart at hand to combine colors and materialise the image in your head.**

**If the normal surface colour is this, then what balance of density should the shadow be?** Or what colour tone should the shadow be? - combining colors with strip charts while considering combinations.

**When deciding character colors, we'd trace character designs or in-between animation and actually place colors to decide, but even then we'd first layer skin colour with colors we planned to use for clothes using strip charts, check the balance, then start painting.**
...
**Colour design and colour direction... or rather, the foundation of finishing begins with "learning colors, learning paints."** Especially in "colour specification" work, you can't do the job without properly understanding paint numbers and their colour characteristics and differences. So by painting ourselves this way, we learned paints and colors.

**This remains true in the current digital coloring era.** Though tangible things like strip charts no longer exist, whether for character samples or anything else, imagining colors yourself and actually painting them to think things through is a fundamental principle for us in colour design and colour direction.
