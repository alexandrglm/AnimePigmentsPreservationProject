...
Speaking of missing settings, I actually forgot that we hadn't created digital coloring colour direction for Bear Geki and others (sweat), so I had Akimoto-san handle all of that through screen matching too.
...
These are anime original colorings. In the original colour settings, all five were the same gold colour, but that overlapped too much with Gold Saints. Actually, from the end of episode 3, Seiya and others are wearing Gold Cloths, so even changing them a bit would still be hard to differentiate on screen.

And I wanted to bring out each of the five's individual "colors" from the Cloths they'd fought in until then. The God Cloths' basic whitish colour is common to all five, with their respective "colors" applied to the shadow colors.
