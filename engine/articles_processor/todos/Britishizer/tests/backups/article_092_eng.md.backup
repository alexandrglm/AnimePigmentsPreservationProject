...
I connected the LD player to an HD-DVD recorder and tried dubbing. Since it's such an old LD player, naturally it's analog connection. I managed to dub it somehow, but ah, the noise... the colour... Apparently it's due to the old LD player. It's about 20 years old now...
...
Several methods existed. First, during coloring, composite this animation and paint with "light-hitting" colors. Second, colour this "net pattern" as separate cel material in white, then photograph it with multiple exposure overexposure to create bright, blown-out colors (super). Third, create a transmitted light mask from this animation and apply transmitted light to literally add light, among others.

First, the coloring method was rejected because "it inevitably looks like 'net-patterned dolphins' swimming." The second photography super method also wasn't much different from coloring in the end, and we couldn't control brightness, darkness, and colour tone as desired, so it was rejected.
