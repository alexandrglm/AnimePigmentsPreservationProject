...
I sent the first batch of character colour samples to original creator Oda-san and waited several days. The long-awaited response came back. However, it wasn't a particularly favorable response.

There weren't any particular comments about the base colors I'd created—Robin with bright skin and Nami with light hair colour seemed "OK"—but the costume colors were apparently lacking somehow. "The excitement doesn't come through"—I believe that was the comment.

The colors I'd conceived and built up had shifted somewhat toward a realistic direction in their coordination, and in addition to aiming too much for the original colour illustrations' atmosphere, from the director's word "transparency," I'd made the colors overall too light. That seemed to be the problem. The colors themselves probably lacked a bit of "powerful projection" or "volume." Looking back, there are several things that make me think "Yeah, that's right..."
...
We ended up having to ask Oda-sensei to do the costume colour coordination concepts. Additional work amid his incredibly busy weekly serialization schedule—I was full of apologetic feelings.

After waiting about three more weeks, it arrived from Oda-san—the raw manuscript of colour concepts. Character line art arranged in rows, with colors carefully placed using colour ink (I think?). Oda-san must have pondered various options too, because on top of the once-colored versions, 2-3 alternative options per character were overlaid and pasted, neatly organized so the first choice was on top.
...
However, at this point, we were right up against the "preview trailer" production deadline... The character designs themselves weren't changing, so animation work could proceed, but without finalised colors, colour direction (色指定) couldn't be done. Without colors, naturally the trailer couldn't be made. But the deadline was also tight. This was something that absolutely couldn't be helped. We couldn't wait for Oda-san's OK before applying colors...
...
So we proceeded with trailer production and work while waiting for Oda-san's response. I created trailer colour direction based on the colors I'd sent to Oda-san for checking and proceeded with cut-by-cut colour direction. We'd push the work forward anyway, and if Oda-san gave his OK, we'd continue as-is. If retakes or changes came back, we'd respond to make the deadline somehow—that was the strategy.
