#!/usr/bin/env python3
"""
Revisor visual de problemas de estilo markdown a docx/html/pdf/etc etc etc.
Como idea es buena. En la práctica no es muy util aun.
Deberá adaptarse a cualquier tipo de filenames
"""
...
# añadir todas las coincidencias progblematicas pendientes
todosLosPatterns = [
    r'\*\*\*.+?\*\*\*',
    r'\*\*.*\*.+?\*.*\*\*',
    r'^(#+\s.*\*.*\*\*.*)$',
        ...
        for pat in todosLosPatterns:
            ...
            for m in re.finditer(pat, modified_line):
                ...
                if choice == '1':
                    ...
                    pass  # no funciona del todo bien aun; deberia pasar al siguiente file
...
def main():
    ...
    # solo valido para los article_XXX_eng
